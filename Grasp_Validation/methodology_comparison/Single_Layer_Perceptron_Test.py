...
def single_layer_perceptron(X_train_scaled, X_test_scaled, y_grip_train, y_grip_test, grip_categories):

    # Grip classification
    grip_model = Perceptron(max_iter=1000)
    ...
    # Save model
    save_model_with_timestamp(grip_model, 'grip_single_layer_model')
